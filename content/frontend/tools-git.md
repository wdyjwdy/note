...
```color
@[red]{??} a.txt # file is untracked.
 @[red]{M} a.txt # Index and Working Tree differ, existing file modified.
@[green]{M}  a.txt # Index and Repository differ, existing file modified.
@[green]{A}  a.txt # Index and Repository differ, new file added.
```
