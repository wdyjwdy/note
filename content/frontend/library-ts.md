...
- **Declaration Scope**: `interface` can only define object types, while `type` can define any type.
- **Declaration Merging**: `interface` supports duplicate declarations, and TypeScript will automatically merge their properties. `type` does not support this.
- **Type computation**: `type` supports more complex type operations.
